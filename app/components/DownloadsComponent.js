        ...
        <div>
          <Grid sx={{ ml: 2, marginTop: 4, marginRight: 2, marginBottom: 2 }}>
            ...
            <Typography variant="p" sx={{ml:1}}>
              Download a selected study in tab separated files or as an ARC-RO-crate. For more details please see <b><a target="blind" href="https://ataulhaleem.github.io/camelina-hub-documentation/downloads">documentation</a></b>
            </Typography>

            <Grid sx={{ mt: 2 }}>
              {/* <Autocomplete
                size="small"
                defaultValue={selectedStudy.study_title}
                options={studies.map((study) => study.study_title)}
                renderInput={(params) => (
                  <TextField
                    {...params}
                    label="Study Title"
                    sx={{
                      "& .MuiOutlinedInput-root": {
                        "& fieldset": {
                          borderColor: selectedStudy ? "green" : "red",
                        },
                      },
                    }}
                  />
...
<SearchGrid  studies={studies} onSelection={handleSelection2}></SearchGrid>
          ...
          >
            <Grid item sx={{ padding: 1, width: "50%" }}>
              <Downloads studyId={selectedStudy.study_identifier} />
            </Grid>
